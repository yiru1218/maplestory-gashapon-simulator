...
# collection
fashion_box_prob_col = msdb["fashion_box_prob"]
fashion_box_pool.mongodb_col = fashion_box_prob_col

### 寵物隨機箱 ###
pet_box_pool = ItemPool()
# collection
pet_box_prob_col = msdb["pet_box_prob"]
pet_box_pool.mongodb_col = pet_box_prob_col
